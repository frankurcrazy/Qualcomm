...
// i.e.  CScript CDMARXPower.js <ISF File Name> [Excel File Name]
...
function ParseArguments()
{
   ...
   var Txt = "";
   var Help =
      "Syntax: CScript CDMARXPower.js <ISF File Name> [Excel File Name]\n"
    + "Eg:     CScript CDMARXPower.js \"CDMA Power.isf\" \"CDMA Power.xls\"\n";
...
function Analyze()
{
   ...
   for (var ItemIndex = 0; ItemIndex < ItemCount; ItemIndex++)
   {
      ...
      while (FI != 0xFFFFFFFF)
      {
         ...
         if (FI != 0xFFFFFFFF)
         {
            var RXPower = Fields.GetFieldValue( FI++ );

            // Convert to dBm
            RXPower = (RXPower / 3) - 63.248;
            RXPower = Math.round( RXPower );

            gRXPower[RXPower] = gRXPower[RXPower] + 1;
            gSamples++;
         }
      }
   }
