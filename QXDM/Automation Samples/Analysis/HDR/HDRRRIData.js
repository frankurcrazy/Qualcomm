...
// i.e.  CScript HDRRRIData.js <ISF File Name> [Excel File Name]
...
var gConditionalArray = new Array();
var gTransmittedArray = new Array();
...
function ParseArguments()
{
   ...
   var Txt = "";
   var Help =
      "Syntax: CScript HDRRRIData.js <ISF File Name> [Excel File Name]\n"
    + "Eg:     CScript HDRRRIData.js \"HDR Data.isf\" \"HDR Data.xls\"\n";
...
function Analyze()
{
   ...
   for (var ItemIndex = 0; ItemIndex < ItemCount; ItemIndex++)
   {
      ...
      // Power Amplifier Max
      var MaxRate = Fields.GetFieldValue( 5 );
      if (MaxRate in gMaxArray)
      {
         gMaxArray[MaxRate] = gMaxArray[MaxRate] + 1;
      }

      // Conditional RRI
      var CondRRI = Fields.GetFieldValue( 6 );
      if (CondRRI in gConditionalArray)
      {
         gConditionalArray[CondRRI] = gConditionalArray[CondRRI] + 1;
      }

      // Actual Transmitted RRI
      var TxRRI = Fields.GetFieldValue( 7 );
      if (TxRRI in gTransmittedArray)
      {
         gTransmittedArray[TxRRI] = gTransmittedArray[TxRRI] + 1;
      }
   }
...
function PopulateExcelSpreadsheet( Sheet )
{
   ...
   var Range = Sheet.Range( "C2:C8, E2:E8, G2:G8" );
   if (Range == null)
   {
      return RC;
   }
