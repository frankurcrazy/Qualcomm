...
// i.e.  CScript HDRTXPower.js <ISF File Name> [Excel File Name]
...
var IISF             = null;
var gSamples         = 0;
var gTXTotalPower    = new Array();
var gTXPilotPower    = new Array();
...
function ParseArguments()
{
   ...
   var Txt = "";
   var Help =
      "Syntax: CScript HDRTXPower.js <ISF File Name> [Excel File Name]\n"
    + "Eg:     CScript HDRTXPower.js \"HDR Power.isf\" \"HDR Power.xls\"\n";
...
function Analyze()
{
   ...
   for (var ItemIndex = 0; ItemIndex < ItemCount; ItemIndex++)
   {
      ...
      for (var Frame = 1; Frame <= 2; Frame++, FieldIndex += 9)
      {
         ...
         var PilotPower = Fields.GetFieldValue( FieldIndex + 3 );
         var TotalPower = Fields.GetFieldValue( FieldIndex + 4 );
         ...
         PilotPower = Math.round( PilotPower );
