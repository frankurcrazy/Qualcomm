...
# i.e.  Perl HDRAccessAttemptTime.pl <ISF File Name> [Excel File Name]
...
sub ParseArguments
{
   ...
   my $Txt = "";
   my $Help =
      "Syntax: Perl HDRAccessAttemptTime.pl <ISF File Name> [Excel File Name]\n"
    . "Eg:     Perl HDRAccessAttemptTime.pl \"HDR Attempts.isf\" \"HDR Attempts.xls\"\n";
...
sub Analyze
{
   ...
   for (my $ItemIndex = 0; $ItemIndex < $ItemCount; $ItemIndex++)
   {
      ...
      my $Duration = $Fields->GetFieldValue( 5 );
