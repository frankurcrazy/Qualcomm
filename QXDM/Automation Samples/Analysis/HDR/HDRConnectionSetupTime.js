...
// i.e.  CScript HDRConnectionSetupTime.js <ISF File Name> [Excel File Name]
...
function ParseArguments()
{
   ...
   var Txt = "";
   var Help =
      "Syntax: CScript HDRConnectionSetupTime.js <ISF File Name> [Excel File Name]\n"
    + "Eg:     CScript HDRConnectionSetupTime.js \"HDR Attempts.isf\" \"HDR Attempts.xls\"\n";
...
function Analyze()
{
   ...
   for (var ItemIndex = 0; ItemIndex < ItemCount; ItemIndex++)
   {
      ...
      var Duration = Fields.GetFieldValue( 4 );
