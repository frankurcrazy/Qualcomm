...
# i.e.  Perl ISFGetItemSummary.pl

# This script demostrates usage of the IColorItem automation
# interface method GetItemSummary()
...
sub DumpItemSummary
{
   ...
   my $Summary = $Item->GetItemSummary();
   if ($Summary eq "")
   {
      print "\nUnable to retrieve item summary\n";
      return;
   }

   print "\nItem summary is '" . $Summary . "'\n";
}
